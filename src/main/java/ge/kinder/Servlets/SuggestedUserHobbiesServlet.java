...
@WebServlet(name = "SuggestedUserHobbiesServlet", urlPatterns = "/SuggestedUserHobbiesServlet")
public class SuggestedUserHobbiesServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            List<Hobby> info =user.getHobbies();
            List<String> hobbies = new ArrayList<>();
            for(Hobby hobby : info){
                hobbies.add(String.valueOf(hobby));
            }



            String json = (new Gson()).toJson(hobbies);
