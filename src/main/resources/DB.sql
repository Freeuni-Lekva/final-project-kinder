...
INSERT INTO Kinder_Base.User ( Mail,                            First_Name, Birth_Date,        City,    Gender, Show_Gender, Preference, Orientation,                                                Bio, Horoscope,             Company,            Job, School,                          Min_Age, Max_Age,  Show_Active, Last_Session, Hided, Role, Show_To_Liked, Balance,Show_Recently_Active, Premium, Search_In_Range)
                            VALUES ( 'kakhikurasbediani@gmail.com', 'Kakhi',      '2000-06-20', 'Tbilisi', 'Man',         1,       'Woman', 'Straight',   'Hello, I am Kakhi! I am ESM student from Tbilisi.', null,      'Bank of Georgia',  'Marketing Guru', 'FreeUni',  '20',     '30',    0,           '2022-09-09 18:40:18',           0,  'USER',     0,          100,         0,               0,       0);
INSERT INTO Kinder_Base.User ( Mail,                                First_Name, Birth_Date,        City,    Gender, Show_Gender, Preference, Orientation,                                                Bio, Horoscope,             Company,            Job, School,                          Min_Age, Max_Age,  Show_Active, Last_Session, Hided, Role, Show_To_Liked, Balance,Show_Recently_Active, Premium, Search_In_Range)
...
INSERT INTO Kinder_Base.User ( Mail,                                First_Name, Birth_Date,        City,    Gender, Show_Gender, Preference, Orientation,                                                Bio, Horoscope,             Company,            Job, School,                          Min_Age, Max_Age,  Show_Active, Last_Session, Hided, Role, Show_To_Liked, Balance,Show_Recently_Active, Premium, Search_In_Range)
                             VALUES ( 'lgham18@freeuni.edu.ge',      'Lasha',      '2000-08-30', 'Tbilisi', 'Man',         1,       'Woman', 'Straight',   'Hello, I am Lasha! I am ESM student from Tbilisi.', null,      'BOG',  'Another Marketing Guru', 'FreeUni',       null,    null,    0,           '2022-09-09 18:40:18',           0,  'USER',     0,          100,         0,               1,       0);
